    ...
    <?php if(!empty($_SESSION['permisos'][4]['r'])) { ?>
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/inventario">
    ...
    <?php if(!empty($_SESSION['permisos'][5]['r'])) { ?>
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/menus">
                <i class="app-menu__icon fa fa-cutlery" aria-hidden="true"></i>
                <span class="app-menu__label">Menús</span>
            </a>
        </li>
    <?php } ?>
    <?php if(!empty($_SESSION['permisos'][6]['r'])) { ?>
        <li>
            <a class="app-menu__item" href="<?= base_url();?>/reportes">
                <i class="app-menu__icon fa fa-file-pdf-o" aria-hidden="true"></i>
